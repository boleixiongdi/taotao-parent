 ...
 */
function login() {
    return location.href = "http://localhost:8090/taotao-sso/user/showLogin";
    //return location.href = "http://sso.taotao.com/user/showLogin";
}
function regist() {
    return location.href = "http://localhost:8090/taotao-sso/user/showRegister";
...
function search(a) {
    var b = "http://localhost:8090/taotao-search/search/query?q=" + encodeURIComponent(document.getElementById(a).value);
